...
function addEnvironment() {
    ...
    var worldMaterial = new THREE.MeshPhongMaterial({ side: THREE.DoubleSide, color: 0xff0000 });
    var worldGeometry = new THREE.SphereGeometry(1000, 50, 50);
...
function addWater() {
    ...
    var waterMaterial = new THREE.MeshBasicMaterial({ color: 0x8800ff, vertexColors: THREE.VertexColors });
...
function addAudio() {
    ...
    var frequencies = [196.0, 146.83, 130.81];
...
function render() {
    var delta = performance.now() * 0.001;
    var angle = delta * 0.05;
